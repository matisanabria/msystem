...
return [
    ...
    "money_remaining"                  => "Money remaining",
    ...
    "pin_identify"                     => "Identify yourself to sell",
    "pin_enter_prompt"                 => "Enter your 4-digit PIN",
    "pin_enter"                        => "Enter",
    "pin_incorrect"                    => "Incorrect PIN",
    "pin_invalid"                      => "Invalid PIN — enter 4 digits",
    "pin_back"                         => "Back",
    "price_check"                      => "Price check",
    "stock_consult"                    => "Stock Consultation",
    "stock_consult_title"              => "Available Stock",
    "stock_consult_search"             => "Search by name or barcode...",
    "stock_consult_all_categories"     => "All categories",
    "items_sold"                       => "Items",
    "barcodes"                         => "Barcodes",
