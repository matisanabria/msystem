...
return [
    ...
    "details_count"                      => "Detalles de Conteo de Inventario",
    ...
    "inventory_data_tracking"            => "Historial de Movimientos de Inventario",
    "inventory_date"                     => "Fecha",
    "inventory_employee"                 => "Empleado",
    "inventory_in_out_quantity"          => "Cantidad Entrada/Salida",
    ...
    "number_required"                    => "El código de barras es requerido.",
    ...
    "successful_bulk_edit"               => "Artículos seleccionados actualizados correctamente",
