...
return [
    ...
    "config_desc"                => "Cambiar Configuracion de MSystem.",
    "customers"                  => "Clientes",
    ...
    "migrate"                    => "Migrar",
    "migrate_desc"               => "Actualizar la Base de Datos de MSystem.",
    "office"                     => "Oficina",
    ...
    "service_tickets"            => "Fichas Técnicas",
    "service_tickets_desc"       => "Agregar, Actualizar, Borrar y Buscar Fichas Técnicas de Servicio.",
