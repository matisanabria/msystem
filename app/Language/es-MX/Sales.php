...
return [
    ...
    "money_remaining"                  => "Dinero faltante",
    ...
    "pin_identify"                     => "Identifícate para vender",
    "pin_enter_prompt"                 => "Ingresa tu PIN de 4 dígitos",
    "pin_enter"                        => "Ingresar",
    "pin_incorrect"                    => "PIN incorrecto",
    "pin_invalid"                      => "PIN inválido — ingresa 4 dígitos",
    "pin_back"                         => "Volver",
    "price_check"                      => "Consulta de precio",
    "stock_consult"                    => "Consulta de Stock",
    "stock_consult_title"              => "Stock Disponible",
    "stock_consult_search"             => "Buscar por nombre o código de barras...",
    "stock_consult_all_categories"     => "Todas las categorías",
    "items_sold"                       => "Artículos",
    "barcodes"                         => "Cód. Barras",
    "sale_channel"                     => "Canal",
    "sale_channel_store"               => "Tienda",
    "sale_channel_delivery"            => "Delivery",
    "sale_channel_shipping"            => "Envío",
];
